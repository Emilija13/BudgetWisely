...
public class TransactionServiceImpl implements TransactionService {
    ...
    public Optional<Transaction> save(TransactionRequestDto transactionDto) {
        ...
        if (Boolean.TRUE.equals(transactionDto.getIsRecurring()) &&
                transactionDto.getFrequency() != null &&
                transactionDto.getFrequency() != RecurrenceFrequency.NONE) {

            recurringTransaction = createRecurringTransaction(transactionDto, category, account);
        }
        ...
        if (recurringTransaction != null) {
            ...
            transaction.setIsAutoGenerated(false);
        }
    ...
    private RecurringTransaction createRecurringTransaction(
            TransactionRequestDto dto, Category category, Account account) {
        ...
        LocalDate startDate = dto.getDate().toLocalDate();
    ...
    @Transactional
    public Transaction saveGeneratedTransaction(Transaction transaction) {
        this.transactionRepository.save(transaction);
        updateAccountAndBudget(
        ...
        logger.info("Auto-generated transaction saved with ID: " + transaction.getId());
