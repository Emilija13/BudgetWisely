...
function OverviewPage() {
    ...
    useState<FilteredTransactionsDto>();
    ...
    const [donutChartTransactions, setDonutChartTransactions] =
        useState<FilteredTransactionsDto>();
    const [barChartTransactions, setBarChartTransactions] =
        useState<FilteredTransactionsDto>();
    ...
    return (
        <section className="w-full">
            ...
            <div className="p-10 mx-10 pt-[4rem] flex justify-between">
                ...
                <Typography
                    variant="lead"
                    className="font-semibold dark-blue-text text-3xl"
                >
            ...
            {accounts.length === 0 ? (
                ...
                <div className="mx-[4rem]">
                    <div className="flex h-25">
                        <div
                            className="flex w-[77%] h-[25rem] bg-white mr-[2.5rem] rounded-lg"
                            style={{ boxShadow: "0 0px 8px rgba(0, 0, 0, 0.05)" }}
                        >
                            <div className="flex-1 rounded-lg">
                                <div className="text-md font-semibold dark-blue-text mt-8 ml-8">
                                    Total Balance
                                </div>
                                ...
                                <div className="flex justify-center my-10 mt-[40px]">
                                    <div className="text-[37px] ml-2 font-semibold main-color-text">
                                        ...
                                        <span className="text-[20px] font-light ml-1 dark-blue-text">
                                            MKD
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div className="mt-4 mx-4 ml-10">
                                    <div className="font-thin text-gray-600 text-md mb-2">
                                        Accounts:
                                    </div>
                                    <div className="mx-3 overflow-auto h-40 pr-6">
                                        {accounts.map((account) => (
                                            <div>
                                                <div
                                                    key={account.id}
                                                    className="flex justify-between py-2 spacing-3 dark-blue-text"
                                                >
                            ...
                            <div className="w-[550px] bg-white rounded-lg py-7 pl-1">
                                <div className="flex justify-between items-center px-7">
                                    <div className="text-md font-semibold dark-blue-text">
                                        Expenses Analytics
                                    </div>
                                ...
                                <div className="px-[2rem] pt-[2.5rem]">
                                    <DonutChartTransactions
                                        filteredTransactionsDto={donutChartTransactions!}
                                    ></DonutChartTransactions>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="w-[100%] h-[23rem]">
                                <div className="flex">
                                    ...
                                    <div className="flex flex-grow rounded-lg h-[22.6rem]">
                                        ...
                                        <div
                                            className="w-[312px] bg-white rounded-lg"
                                            style={{ boxShadow: "0 0px 8px rgba(0, 0, 0, 0.05)" }}
                                        >
                                            <div className="text-md font-semibold dark-blue-text mt-8 ml-8 mb-6">
                                                Total budget expenditures
                                            </div>
                                            <div className="px-9">
                                                <div className="text-sm font-thin text-gray-700 custom-select mb-3">
                                                    This month
                                                </div>
                                                <DonutChartBudgetProgress
