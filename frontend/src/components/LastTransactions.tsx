                        ...
                        <div key={index} className="group hover:bg-gray-50">
                            <div className="h-[3.7rem] pt-1">
                                <div className="relative">
                                    ...
                                    <div
                                        className={`absolute left-0 top-0 bottom-0 w-[3px] ${transaction.type === TransactionType.INCOME ? 'bg-[#00B58D]' : 'bg-[#FF6161]'} rounded-[2px] group-hover:w-[4px] group-hover:opacity-100 opacity-75 transition-all duration-200`}
                                    ></div>
